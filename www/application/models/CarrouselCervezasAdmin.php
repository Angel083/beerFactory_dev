...
class CarrouselCervezasAdmin extends CI_Controller {
    ...
    public function update(){
        ...
        if($this->carrousel_cervezas_model->update($data,$_POST['id_imgen'])){
                $response["status"] = "OK";
    ...
    public function delete(){
        $response = array();
        $this->load->model($this->name_model);
        if($this->carrousel_cervezas_model->delete($_POST['id_imgen'])){
            $response["status"] = "OK";
    ...
    public function getById(){
        $this->load->model($this->name_model);
        $myJSON = json_encode($this->carrousel_cervezas_model->getById($_POST['id_imgen']));
        echo $myJSON;
    }

    function cargar_archivo() {
        $nombreArchivo = $_FILES['mi_archivo']['name'];
        $ruta =  $_SERVER['DOCUMENT_ROOT']."/beer_factory/recs/assets/images/Cervezas/";
        ...
        if (!$this->upload->do_upload($mi_archivo)) {
            ...
            $data['uploadError'] = $this->upload->display_errors();
             ...
             echo "<p>Fallo subir el archivo<a href='http://www.onexo.mx/beer_factory/index.php/CervezasAdmin/index'>Regresar/a></p>";
             return;
        }
