...
<div class="container-fluid container-promociones">
    ...
    <div class="text-center">
        ...
        <img src="<?= base_url('recs/assets/images/Promociones/BF_Elementos-Cervezas-Paths_6.png') ?>"

            class="img-fluid img-promociones" alt="Responsive image">
    ...
    <div class="container-fluid" id="sec-promociones">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6" id="col-img-cervezas-1">

                <a class="thumbnail content-imgs">

                    <img src="<?= base_url('recs/assets/images/Promociones/').$column->nombre_imagen;?>"

                        class="img-fluid img-back-cervezas" alt="Responsive image"

                        id="img-promocion-<?= $column->id_promocion?>">

                    <div class="div-opciones" style="display:none" id="opciones-<?= $column->id_promocion?>">
                        ...
                        <ul class="list-group list-group-horizontal-md list-group-opciones">
                            ...
                            <li class="list-group-item list-group-item-eliminar list-group-item-img"
                                ...
                                data-book-id="book-el-<?= $column->id_promocion?>" id="el-<?= $column->id_promocion?>"
                ...
                <div class="text-center">
                    ...
                    <a target="_blank"
                        ...
                        href="<?= base_url('recs/assets/images/Promociones/').$column->nombre_pdf;?>"

                        class="restricciones">Restricciones</a>
            ...
            <div class="col-12 col-md-6 col-add-img" id="col-img-cervezas-5">
        ...
        <div class="modal-content modal-content-galeria">
            ...
            <div class="modal-footer modal-footer-galeria">
                ...
                <div class="text-center">
                    ...
                    <button type="button" class="btn btn-secondary btn-left-image" id="show-previous-image"><i
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-center">
                    ...
                    <p>Selecciona los archivos para agregar la promoción</p>

                    <form action="<?= base_url("index.php/PromocionesAdmin/cargar_archivo")?>" method="post"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="custom-file">
                                    ...
                                    <input type="file" class="custom-file-input" id="validatedCustomFile"
                                        ...
                                        name="mi_archivo_pdf" required>

                                    <label class="custom-file-label" for="validatedCustomFile">Elige un archivo
        ...
        <div class="modal-content modal-content-subir">
            ...
            <div class="modal-body">
                ...
                <div class="text-center">
                    ...
                    <p>¿Esta seguro que desea eliminar la promoción?</p>
...
$("#img-promocion-<?= $column->id_promocion?>").hover(function() {

        $("#opciones-<?= $column->id_promocion?>").show();
    ...
    function() {
        ...
        $("#opciones-<?= $column->id_promocion?>").hide();
...
$("#opciones-<?= $column->id_promocion?>").hover(function() {
...
<script src="<?= base_url('recs/assets/js/promocionesAdmin.js') ?>"></script>