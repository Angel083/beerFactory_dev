    ...
    <div class="container-fluid container-imgs-manteletas">
        <div class="row">
            <div class="col-12 col-xl-6 col-img-manteleta">
                <img src="<?= base_url('recs/assets/images/Menu/Veggie_Burger.png')?>"
                    class="img-fluid img-back-cervezas" alt="Responsive image">
            </div>
            <div class="col-12 col-xl-6 col-img-manteleta">
                <img src="<?= base_url('recs/assets/images/Menu/Mac___Cheese_Wich.png')?>"
                    class="img-fluid img-back-cervezas" alt="Responsive image">
            </div>
            <div class="col-12 col-xl-6 col-img-manteleta">
                <img src="<?= base_url('recs/assets/images/Menu/Pulled_Pork_Burger.png')?>"
                    class="img-fluid img-back-cervezas" alt="Responsive image">
            </div>
            <div class="col-12 col-xl-6 col-img-manteleta">
                <img src="<?= base_url('recs/assets/images/Menu/Grand_comanche_Burger.png')?>"
                    class="img-fluid img-back-cervezas" alt="Responsive image">
            </div>
            <div class="col-12 col-xl-6 col-img-manteleta">
                <img src="<?= base_url('recs/assets/images/Menu/Blue_Cheese_Burger.png')?>"
                    class="img-fluid img-back-cervezas" alt="Responsive image">
            </div>
            <div class="col-12 col-xl-6 col-img-manteleta">
            ...
            <div class="col-12 col-xl-6 col-img-manteleta">
                <img src="<?= base_url('recs/assets/images/Menu/Burrito_Chicken.png')?>"
                    class="img-fluid img-back-cervezas" alt="Responsive image">
            </div>
            <div class="col-12 col-xl-6 col-img-manteleta">
                <img src="<?= base_url('recs/assets/images/Menu/Pibe_Burger.png')?>"
                    class="img-fluid img-back-cervezas" alt="Responsive image">
            </div>
        </div>
    </div>
