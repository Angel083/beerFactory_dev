    ...
    <div class="container-fluid container-imgs-manteletas">
        <div class="row">
            <div class="col-12 col-xl-6 col-img-manteleta">
                <img src="<?= base_url('recs/assets/images/Menu/Chicken___Cheese_Crust.png')?>"
                    class="img-fluid img-back-cervezas" alt="Responsive image">
            </div>
            <div class="col-12 col-xl-6 col-img-manteleta">
                <img src="<?= base_url('recs/assets/images/Menu/Pepperoni___Mushrooms.png')?>"
                    class="img-fluid img-back-cervezas" alt="Responsive image">
            </div>
            <div class="col-12 col-xl-6 col-img-manteleta">
                <img src="<?= base_url('recs/assets/images/Menu/ARGENTINA_PIZZA.png')?>"
                    class="img-fluid img-back-cervezas" alt="Responsive image">
            </div>
            <div class="col-12 col-xl-6 col-img-manteleta">
                <img src="<?= base_url('recs/assets/images/Menu/Mamma’s_Chilli.png')?>"
                    class="img-fluid img-back-cervezas" alt="Responsive image">
            </div>
        </div>
    </div>
