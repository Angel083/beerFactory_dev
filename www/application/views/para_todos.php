    ...
    <div class="container-fluid container-imgs-manteletas">
        <div class="row">
            <div class="col-12 col-xl-6 col-img-manteleta">
                <img src="<?= base_url('recs/assets/images/Menu/Platon_Beer_Factory.png')?>"
                    class="img-fluid img-back-cervezas" alt="Responsive image">
            </div>
            <div class="col-12 col-xl-6 col-img-manteleta">
                <img src="<?= base_url('recs/assets/images/Menu/ALITAS.png')?>"
                    class="img-fluid img-back-cervezas" alt="Responsive image">
            </div>
            <div class="col-12 col-xl-6 col-img-manteleta">
                <img src="<?= base_url('recs/assets/images/Menu/Paquete_Boneless.png')?>"
                    class="img-fluid img-back-cervezas" alt="Responsive image">
            </div>
        </div>
    </div>
